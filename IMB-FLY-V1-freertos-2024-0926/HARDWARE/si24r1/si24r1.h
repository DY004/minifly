...
#define SI24R1_CSN_LOW         HAL_GPIO_WritePin(RF_CSN_GPIO_Port,RF_CSN_Pin,GPIO_PIN_RESET)
#define SI24R1_CSN_HIGH        HAL_GPIO_WritePin(RF_CSN_GPIO_Port,RF_CSN_Pin,GPIO_PIN_SET)
#define SI24R1_CE_LOW          HAL_GPIO_WritePin(RF_CE_GPIO_Port,RF_CE_Pin,GPIO_PIN_RESET) 
#define SI24R1_CE_HIGH         HAL_GPIO_WritePin(RF_CE_GPIO_Port,RF_CE_Pin,GPIO_PIN_SET)
